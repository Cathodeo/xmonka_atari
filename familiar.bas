...
PROC INIT_NEW_FAMILIAR SPECIES
    ...
    CURRENT_FAMILIAR(9) = 0
ENDPROC


PROC INIT_NEW_FOE_FAMILIAR SPECIES
    CURRENT_FOE_FAMILIAR(0) = SPECIES
    CURRENT_FOE_FAMILIAR(1) = F_HP(SPECIES)
    CURRENT_FOE_FAMILIAR(2) = F_TYPE(SPECIES)
    CURRENT_FOE_FAMILIAR(3) = F_MOVE(SPECIES)
    CURRENT_FOE_FAMILIAR(4) = F_MOVE(SPECIES) + 1
    CURRENT_FOE_FAMILIAR(5) = 0
    CURRENT_FOE_FAMILIAR(6) = 0
    CURRENT_FOE_FAMILIAR(7) = F_COOLDOWN(SPECIES)
    CURRENT_FOE_FAMILIAR(8) = F_ABILITY(SPECIES)
    CURRENT_FOE_FAMILIAR(9) = 0
ENDPROC
